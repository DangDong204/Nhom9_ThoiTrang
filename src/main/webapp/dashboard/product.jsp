				...
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<!-- Form lọc sản phẩm -->
							<form action="quanly-sanpham" method="get" class="row g-2 align-items-center mb-3">
								...
								<div class="col">
									<select name="brandId" class="form-select">
										...
										<c:forEach var="b" items="${listBrand}">
											<option value="${b.brandId}" ${param.brandId == b.brandId ? "selected" : ""}> ${b.brandName} </option>
										</c:forEach>
									</select>
								</div>
								...
								<div class="col">
									<select name="priceRange" class="form-select">
										...
										<option value="lt100" ${param.priceRange == 'lt100' ? "selected" : ""}>Nhỏ hơn  100.000</option>
										<option value="100-200" ${param.priceRange == '100-200' ? "selected" : ""}>Giá từ 100.000 - 200.000</option>
										<option value="200-300" ${param.priceRange == '200-300' ? "selected" : ""}>Giá từ 200.000 - 300.000</option>
										<option value="300-400" ${param.priceRange == '300-400' ? "selected" : ""}>Giá từ 300.000 - 400.000</option>
										<option value="gt400" ${param.priceRange == 'gt400' ? "selected" : ""}>Lớn hơn 400.000</option>
									</select>
								</div>
								...
								<div class="col">
									<select name="quantityRange" class="form-select">
											<option value="" ${empty param.quantityRange ? "selected" : ""}>-- Tình trạng --</option>
											<option value="lt20" ${param.quantityRange == 'lt20' ? "selected" : ""}>Sắp hết hàng </option>
											<option value="gt20" ${param.quantityRange == 'gt20' ? "selected" : ""}>Còn đủ hàng </option>
									</select>
								</div>
								...
								<!-- Nút Xóa lọc -->
								<div class="col-auto">
									<a href="quanly-sanpham" class="btn btn-secondary w-100">Xóa lọc</a>
								</div>
							</form>

							<!-- Export CSV -->
							<form action="ExportCSVServlet" method="get" style="display: inline;">
								<input type="hidden" name="brandId" value="${param.brandId}">
								<input type="hidden" name="categoryId" value="${param.categoryId}">
								<input type="hidden" name="priceRange" value="${param.priceRange}">
								<input type="hidden" name="quantityRange" value="${param.quantityRange}">
								...
								<tbody>
									<c:forEach var="product" items="${listProduct}">
										<tr>
											...
											<td><fmt:formatNumber value="${product.productCost}" type="currency" currencySymbol="VNĐ" groupingUsed="true"/></td>
											<td
