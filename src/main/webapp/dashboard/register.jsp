              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Nhập đầy đủ các thông tin sau</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="${pageContext.request.contextPath}/dashboard/login.jsp">Log in</a></p>
                    </div>
                  </form>
